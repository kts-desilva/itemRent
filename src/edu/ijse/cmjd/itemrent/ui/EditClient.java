    ...
    private void setContent() {
        ...
        editButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                ...
                try {
                    ClientController controller = ServerConnector.serverConnection().getServerConnection();
                    boolean rst = controller.editClient(new ClientM(idText.getSelectedItem().toString(), nameText.getText(), NICText.getText(),
        ...
        countLabel.setBorder(BorderFactory.createLineBorder(new Color(169, 169, 169), 3));

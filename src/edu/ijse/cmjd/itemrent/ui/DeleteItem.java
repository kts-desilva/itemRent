    ...
    private void setContent() {
        ...
        delButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                try {
                    ItemController itemController = ServerConnector.serverConnection().getItemController();
                    boolean deleteItem = itemController.deleteItem(idText.getSelectedItem().toString());
                    if (deleteItem) {
                        new MessagePane(null,  "Delete Sucess !").setVisible(true);
                    } else {
